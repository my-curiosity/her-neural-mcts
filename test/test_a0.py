...
class TestA0(unittest.TestCase):
    ...
    def test_a0_umaze(self):
        sys.argv += (
            " --experiment_name her1_umaze"
            " --job_id 15559341"
            " --minutes_to_run 6800"
            " --max_iteration_to_run 20"
            " --sec_per_simulation -1"
            " --seed 1"
            " --logging_level 30"
            " --wandb online"
            ...
            " --project_name her-neural-mcts-umaze"
            " --lr 0.001"
            " --load_pretrained False"
        ).split()
        run()
    ...
    def test_a0_equation_discovery(self):
        sys.argv += (
            " --experiment_name her1_equation"
            " --job_id 15559341"
            " --minutes_to_run 6800"
            " --max_iteration_to_run 30"
